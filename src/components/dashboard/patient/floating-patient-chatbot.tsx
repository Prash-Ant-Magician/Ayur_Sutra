...
import { Bot, Send, X, User, Loader2, MessageCircle } from "lucide-react";
...
export function FloatingPatientChatbot() {
  const [isOpen, setIsOpen] = useState(false);
  const [messages, setMessages] = useState<Message[]>([
    { sender: "bot", text: "Hello! I am your personal AI assistant. How can I help with your treatment or appointments today?" }
  ]);
